    ...
    return (
        <Navbar collapseOnSelect bg="light" variant="light">
            <div className="container">
                <Navbar.Brand>
                    <NavLink className="navbar-brand" to="/"><strong>example</strong></NavLink>
                </Navbar.Brand>
                <Navbar.Brand  style={{ paddingLeft: '70%' }}>
                    <NavLink className="navbar-brand" to="/Info" >Info</NavLink>
                </Navbar.Brand>
